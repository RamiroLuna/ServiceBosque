...
import org.probosque.controller.ControllerCSV;
import org.probosque.model.json.OutputJson;
import org.probosque.model.json.ResponseJson;

/**
 * Clase que permite almacenar en la base de datos el filtro que sera utilizado al momento de retornar un archivo CSV.
 * No se almacena el contenido del CSV, sólo el filtro que sera aplicado junto con identificador
 */
...
public class CSV extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ControllerCSV controller = new ControllerCSV();
        Gson gson = new Gson();
