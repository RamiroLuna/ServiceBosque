...
import org.probosque.controller.ControllerTablePredios;
import org.probosque.model.json.OutputJson;
import org.probosque.model.json.ResponseJson;

/**
 * Clase que proporciona la información de las columnas y el tipo de cada una de ellas para cada programa en relación a los predios, es la base para conformar cada formulario
 * @author admin
 */

@WebServlet(name = "TablePredios", urlPatterns = {"/TablePredios"})

public class TablePredios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ControllerTablePredios controller = new ControllerTablePredios();
        Gson gson = new Gson();
