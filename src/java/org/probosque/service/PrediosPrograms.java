...
import org.probosque.controller.ControllerPrediosPrograms;
import org.probosque.model.json.OutputJson;
import org.probosque.model.json.ResponseJson;

/**
 * Clase que administra las solicitudes de predios por año y por programa proporcionados.
 * @author admin
 */
@WebServlet(name = "PrediosPrograms", urlPatterns = {"/PrediosPrograms"})
public class PrediosPrograms extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ControllerPrediosPrograms controller = new ControllerPrediosPrograms();
        Gson gson = new Gson();
            
        try {
            responseJson.setMessage("valido");
            responseJson.setSucessfull(true);
            output.setData(controller.getProgramsAnios(request));
        } catch (Exception ex) {
