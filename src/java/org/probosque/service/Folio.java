...
import org.probosque.controller.ControllerFolio;
import org.probosque.model.json.OutputJson;
import org.probosque.model.json.ResponseJson;

/**
 * Clase que administra las solicitudes de nuevos folios para cada formulario, en base al programa, año y región
 * @author admin
 */

@WebServlet(name = "Folio", urlPatterns = {"/Folio"})
public class Folio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ControllerFolio controller = new ControllerFolio();
        Gson gson = new Gson();
        try {
            String action = request.getParameter("action");
            switch (action) {
                case "get":
                    output = controller.getFolio(request);
                    break;
            }
        } catch (Exception ex) {
