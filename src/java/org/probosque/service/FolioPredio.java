...
import org.probosque.controller.ControllerFolioPredio;
import org.probosque.model.json.OutputJson;
import org.probosque.model.json.ResponseJson;

/**
 * Clase que administra las solicitudes de los folios de predio, determina si existen folios de acuerdo a los parametros requeridos
 * @author admin
 */
@WebServlet(name = "FolioPredio", urlPatterns = {"/FolioPredio"})
public class FolioPredio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ControllerFolioPredio controller = new ControllerFolioPredio();
        Gson gson = new Gson();
        try {
            responseJson.setMessage("valido");
            responseJson.setSucessfull(true);
            output.setData(controller.getFolioPredio(request));
        } catch (Exception ex) {
