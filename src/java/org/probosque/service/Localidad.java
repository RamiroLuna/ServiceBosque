...
import org.probosque.controller.ControllerLocalidad;
import org.probosque.model.json.OutputJson;
import org.probosque.model.json.ResponseJson;

/**
 * Clase que permite retornar el listado de localides pertenecientes a un determinado municipio
 * @author admin
 */
@WebServlet(name = "Localidad", urlPatterns = {"/Localidad"})
public class Localidad extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            output.setData(controller.getLocalidades(request));
        } catch (Exception ex) {
