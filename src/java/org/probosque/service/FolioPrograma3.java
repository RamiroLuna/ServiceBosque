...
import org.probosque.controller.ControllerFolioPrograma3;
import org.probosque.model.json.OutputJson;
import org.probosque.model.json.ResponseJson;

/**
 * Clase que administra las solicitudes de nuevos folios para cada formulario, solo del programa 3, ya que este programa solicito un folio especifico además del folio general
 * @author admin
 */
@WebServlet(name = "FolioPrograma3", urlPatterns = {"/FolioPrograma3"})
public class FolioPrograma3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ControllerFolioPrograma3 controller = new ControllerFolioPrograma3();
        Gson gson = new Gson();
        try {
            output = controller.getFolioPrograma3(request);
        } catch (Exception ex) {
