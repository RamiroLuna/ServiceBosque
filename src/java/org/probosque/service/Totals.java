...
import org.probosque.controller.ControllerTotal;
import org.probosque.model.json.OutputJson;
import org.probosque.model.json.ResponseJson;

/**
 * Clase que retorna la información necesaria para construir las gráficas de cada capa geográfica
 * @author admin
 */
...
public class Totals extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ControllerTotal controller = new ControllerTotal();
        Gson gson = new Gson();
        ...
        try {
            ...
            switch (action) {
                case "get":
                    output.setData(controller.getTotals(request));
                    break;
                default:
