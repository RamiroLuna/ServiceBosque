...
/**
 * Clase que administra cada una de las acciones que hara el servlet en base a la petición de información correspondiente para la construcción de los formularios
 * @author admin
 */

public class ControllerTablePrediosAnios {
    ...
    public OutputJson getTable(HttpServletRequest request) {
        ...
        try {
            ...
            table.setColumns((ArrayList<ColumnDTO>) dao.getColumnsPrediosAnios());
